<template>
    <div>
        <!-- Edit Task Modal -->
        <el-dialog title="Edit Task" :visible.sync="openEditModal" width="80%" :close-on-click-modal="false">
            <el-form :model="form">
              ...
              <el-form-item :label-width="formLabelWidth">
                <el-button type="primary" size="medium" @click="updateTask">Update</el-button>
              </el-form-item>
            </el-form>
        </el-dialog>
    </div>
