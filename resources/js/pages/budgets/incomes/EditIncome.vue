<template>
    <div>
        <!-- Edit Income Modal -->
        <el-dialog title="Edit Income" :visible.sync="openEditModal" width="80%" :close-on-click-modal="false">
            <el-form :model="form">
              <el-form-item label="Name" :label-width="formLabelWidth">
                ...
                <el-form-item :label-width="formLabelWidth">
                    <el-button type="primary" size="medium" @click="updateIncome">Update</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
    </div>
...
export default {
    ...
    methods:{
        updateIncome(){
            ...
            axios.post('/income/'+editData.id,editData)
                .then(response => {

                    this.$emit('editedIncome', false);
